          ...
          <div className="pl-16 pr-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-12 pb-20">
                <section
                  id="about"
                  className="space-y-4 border-b border-[#2d2d2d] pb-4"
                >
                  <h2 className="text-[#4ec9b0] text-2xl">About Me</h2>
                  <p className="text-gray-300">
                    Hi, I am{" "}
                    <strong>
                      Foodchain, aka Fu-Chuan Chung (鍾富全 in Mandarin), Jeff
                    </strong>{" "}
                    from Kaohsiung, Taiwan.
                  </p>
                  <p className="text-gray-300">
                    I am still a student pursuing my MSc degree of Software
                    Development in University of Glasgow. I am interested in
                    zero knowledge and am researching on several topic by myself
                    🛵. I am currently working on 2 projects: `social-tw` and
                    `mopro`.
                  </p>
                </section>
                ...
                >
                  ...
                  <p className="text-gray-300">
                    In my spare time, I love listening to jazz music and also
