...
const posts = [
  ...
  },
  {
    ...
    slug: "zkvaxcard",
    excerpt:
      "zkVaxCard 是一個可以幫助人們在「不揭露任何個人資訊如身分證字號、個人照片或健保卡卡號」之情況下「證明自己有接種過疫苗」之系統。",
  ...
  },
  {
    ...
    slug: "MACI",
    excerpt:
      "在區塊鏈投票時，常會發生「共謀」的現象 (最常見的就是賄賂 )，而為了遏止此現象的發生，Barry White Hat 與 Ethereum 中其他成員建構了 MACI 這個 protocol...",
    tags: ["zk", "cryptography", "中文"],
  },
  {
  ...
  },
  {
    ...
    slug: "Ethereum-Basis",
    excerpt:
      "以太坊與比特幣的相關性非常多，本文會稍微提及以太坊之歷史並分享一些關於以太坊的基本運行方式。",
    tags: ["blockchain", "中文"],
  },
];
        ...
        <div className="relative">
          ...
          <div className="pl-16 pr-4">
            <div className="max-w-4xl mx-auto">
              <PageHeader title="Posts" description="Research & Outputs" />
